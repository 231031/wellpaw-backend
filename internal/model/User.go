...
type User struct {
	...
	NotiUpdatePet      bool                   `gorm:"type:boolean;default:true;not null" json:"noti_update_pet"`
	...
	SubscriptionStatus SubscriptionStatusType `gorm:"default:2;not null" json:"subscription_status"`
